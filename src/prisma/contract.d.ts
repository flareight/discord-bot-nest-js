...
export type StorageHash =
  StorageHashBase<'9a501c67d088acfa2831b95ee006dc1c1c06a1fb8ee5b1c47b348f1b9387b458'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly BotLogs: {
      ...
      readonly userId: Varchar<30>;
      readonly username: Varchar<50>;
      readonly command: Varchar<50>;
      readonly args: Varchar<50>;
...
export type FieldInputTypes = {
  readonly public: {
    readonly BotLogs: {
      ...
      readonly command: CodecTypes['sql/varchar@1']['input'];
      readonly args: CodecTypes['sql/varchar@1']['input'];
...
export type StorageColumnInputTypes = {
  readonly public: {
    readonly bot_logs: {
      ...
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly user_id: CodecTypes['sql/varchar@1']['input'];
      readonly username: CodecTypes['sql/varchar@1']['input'];
    };
  };
};
        ...
        readonly entries: {
          readonly table: {
            readonly bot_logs: {
              ...
              primaryKey: { readonly columns: readonly ['id']; readonly name: 'bot_logs_pkey' };
              uniques: readonly [];
              indexes: readonly [];
...
> & {
  ...
  readonly roots: {
    readonly bot_logs: { readonly namespace: 'public' & NamespaceId; readonly model: 'BotLogs' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
          ...
          readonly BotLogs: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly args: { readonly column: 'args' };
